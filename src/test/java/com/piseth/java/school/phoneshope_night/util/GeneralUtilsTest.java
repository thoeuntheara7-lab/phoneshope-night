package com.piseth.java.school.phoneshope_night.util;
...
import com.piseth.java.school.phoneshope_night.utils.GeneralUtils;

public class GeneralUtilsTest {
	@Test
	public void toIngeterList() {
		// Given
		List<String> names = List.of("Dara","Cheata","Thida");
		// When
		List<Integer> list = GeneralUtils.toIngeterList(names);
		// Then
		// [4,6,5]
